                            ...
                            <div class="col-md-12">
                                <div class="panel panel-white" style="margin-bottom: 0px;">
                                    <div class="panel-heading clearfix">
                                        <h4 class="panel-title">All Assignments</h4>
                                    </div>
...
<!--                                            <tbody>-->
                                                <%
                                                    ...
                                                    List<MessageDTO> dto = dao.getAllAssignments(username,"faculty","student");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><form action="studentDisplayFacultyAssignment.jsp" method="post">
