...
%>
    ...
    <div class="mobile_nav">
      ...
      <div class="mobile_nav_items">
        <a href="adminHome.jsp"><i class="fa fa-id-badge"></i><span>Profile</span></a>
      <div class="show1">
    ...
    <div class="sidebar">
      ...
      <a href="adminHome.jsp"><i class="fa fa-id-badge fa-lg"></i><span>Profile</span></a>
      <div class="show1">
        <a href="#"><i class="fa fa-user-plus"></i><span>Add New &nbsp; &nbsp;<i class="fas fa-chevron-down"></i></span></a>
          <div class="hide1">
            <a href="adminAddHod.jsp"><i class="fa fa-user-plus"></i><span>HOD</span></a>
            <a href="adminAddFaculty.jsp"><i class="fa fa-user-plus"></i><span>Faculty</span></a>
            <a href="adminAddStudent.jsp"><i class="fa fa-user-plus"></i><span>Student</span></a>
          </div>
      </div>
      <div class="show1">
        <a href="#"><i class="fa fa-edit"></i><span>Update &nbsp; &nbsp;<i class="fas fa-chevron-down"></i></span></a>
          <div class="hide1">
            <a href="adminUpdateProfile.jsp"><i class="fa fa-edit"></i><span>Profile</span></a>
            <a href="getAddHodId.jsp"><i class="fa fa-edit"></i><span>HOD Details</span></a>
            <a href="getAddFacultyId.jsp"><i class="fa fa-edit"></i><span>Faculty Details</span></a>
            <a href="getAddStudentId.jsp"><i class="fa fa-edit"></i><span>Student Details</span></a>
          </div>
      </div>
      <div class="show1">
        <a href="#"><i class="fa fa-user-times"></i><span>Delete &nbsp; &nbsp;<i class="fas fa-chevron-down"></i></span></a>
          <div class="hide1">
            <a href="adminDeleteHod.jsp"><i class="fa fa-user-times"></i><span>HOD Details</span></a>
            <a href="adminDeleteFaculty.jsp"><i class="fa fa-user-times"></i><span>Faculty Details</span></a>
            <a href="adminDeleteStudent.jsp"><i class="fa fa-user-times"></i><span>Student Details</span></a>
          </div>
      </div>
      <div class="show1">
        <a href="#"><i class="fa fa-users" ></i><span>Display All &nbsp; &nbsp;<i class="fas fa-chevron-down"></i></span></a>
          <div class="hide1">
            <a href="adminDisplayHod.jsp"><i class="fa fa-users" ></i><span>HOD</span></a>
            <a href="adminDisplayFaculty.jsp"><i class="fa fa-users" ></i><span>Faculty</span></a>
            <a href="adminDisplayStudent.jsp"><i class="fa fa-users" ></i><span>Student</span></a>
          </div>
      </div>
      <a href="LogOutCheckerServlet"><i class="fa fa-power-off"></i><span>Log Out</span></a>
    </div>
    <!--sidebar end-->
...
%>                  
              ...
              <div class="col-md-8">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <a class="btn btn-info " href="adminUpdateProfile.jsp">Edit</a>
                        </div>
                      </div>
                    </div>
                  </div>
