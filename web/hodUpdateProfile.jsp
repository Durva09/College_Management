    ...
    <div class="content">
      <div class="container">
        <div class="main-body">
              ...
              <!-- /Breadcrumb -->
<form action="HODUpdateHODServlet" method="post">  
              <div class="container">
              ...
              <div class="container">
                ...
                <br><center>
                  ...
                  <a href="hodHome.jsp" style="text-decoration: none;"><button type="reset" id="submit" name="submit" class="btn btn-secondary">Cancel</button></a>
              </center>   
</form>                
            </div>
        </div>
