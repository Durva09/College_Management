    ...
    <div class="content">
      <div class="container">
        <div class="main-body">
              ...
              <li class="breadcrumb-item active" aria-current="page">DELETE HOD</li>
            </ol>
              </nav>
              <!-- /Breadcrumb -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-white" style="margin-bottom: 0px;">
                                    ...
                                    <h4 class="panel-title">Enter HOD ID </h4>
                                </div>
                                <div class="panel-body">
                                    <form action="AdminDeleteHODServlet" method="post">
                                        <div class="">
                                            <input type="text" name="hod" class="form-control" placeholder="Enter HOD ID To Remove The HOD">
                                        </div><br>
                                ...
                                <div class="panel panel-white" style="margin-bottom: 0px;">
                                    <div class="panel-heading clearfix">
                                        <h4 class="panel-title">All HOD</h4>
                                    </div>
                                    <div class="panel-body">
