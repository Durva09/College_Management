...
<%
    ...
    MessageDTO mdto= msg.getComplains(id);
%>
    ...
    <div class="content">
      <div class="container">
        <div class="main-body">
              ...
              <li class="breadcrumb-item active" aria-current="page">COMPLAIN DISPLAY</li>
            </ol>
              </nav>
              <!-- /Breadcrumb -->
...
<div class="email-app">
    ...
    <main>
        <p class="text-center"><b>COMPLAIN</b></p>
        <form action="HODStudentResponseServlet" method="post">
            <input type="text" value="<%=id%>" name="cid" hidden="true">
            
            <div class="row">
                <div class="col-sm-11">
                    <label for="to">Sender's Name:</label><input type="text" class="form-control" id="to" name="sender" value="<%=mdto.getSender()%>" readonly>
                </div>
            </div>
        <div class="row">
            <div class="col-sm-11">
                <div class="form-group mt-4">
            <label for="message">Complain:</label><textarea class="form-control" id="message" name="message" rows="6" readonly><%=mdto.getMessage()%></textarea>
        </div>
        <div class="row">
            <div class="col-sm-11">
                <div class="form-group mt-4">
            <label for="reply">Response:</label><textarea class="form-control" id="reply" name="reply" rows="6" placeholder="Type your Response"></textarea>
                </div>
