    ...
    <div class="content">
      <div class="container">
        <div class="main-body">
              ...
              <!-- /Breadcrumb -->
<form action="AdminAddStudentServlet" method="post">  
              <div class="container">
                    ...
                    <div class="row gutters">
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="contact" id="phone" placeholder="Enter phone number" required>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container">
                    ...
                    <div class="row gutters">
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="year" id="year" placeholder="YYYY" required>
                        </div>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                ...
                <br><center>
                  ...
                  <a href="#" style="text-decoration: none;"><button type="reset" id="submit" name="submit" class="btn btn-secondary">Cancel</button></a>
              </center>   
</form>                
            </div>
        </div>
