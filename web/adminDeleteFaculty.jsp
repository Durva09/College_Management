    ...
    <div class="content">
      <div class="container">
        <div class="main-body">
              ...
              <li class="breadcrumb-item active" aria-current="page">DELETE Faculty</li>
            </ol>
              </nav>
              <!-- /Breadcrumb -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-white" style="margin-bottom: 0px;">
                                    ...
                                    <h4 class="panel-title">Enter Faculty ID </h4>
                                </div>
                                <div class="panel-body">
                                    <form action="AdminDeleteFacultyServlet" method="post">
                                        <div class="">
                                            <input type="text" name="faculty" class="form-control" placeholder="Enter Faculty ID To Remove The Faculty">
                                        </div><br>
                                ...
                                <div class="panel panel-white" style="margin-bottom: 0px;">
                                    <div class="panel-heading clearfix">
                                        <h4 class="panel-title">All Faculty</h4>
                                    </div>
                                    <div class="panel-body">
