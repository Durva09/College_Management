...
<%
    ...
    MessageDTO mdto= msg.getAssignment(id);
%>
    ...
    <div class="content">
      <div class="container">
        <div class="main-body">
              ...
              <li class="breadcrumb-item active" aria-current="page">ASSIGNMENT DISPLAY</li>
            </ol>
              </nav>
              <!-- /Breadcrumb -->
    ...
    <main>
        ...
        <form action="ShowAssignmentServlet" method="post">
            <%MessageDAO dao=new MessageDAO();
              MessageDTO dto=dao.getAssignment(id);
            %>
            <input type="hidden" name="id" value="<%=id%>">
        <div class="row">
            <div class="col-sm-11">
                <div class="form-group mt-4">
                    <textarea class="form-control" id="reply" name="reply" rows="6">Date:  <%=dto.getDate()%><%out.println();%><%out.println();%>&nbsp;&nbsp;<%=dto.getMessage()%></textarea>
                </div>
            </div>
        </div>
                
        <div class="form-group">
            <center><button type="submit" class="btn btn-success">Assignment</button></center>
        </div>
      </form>
    </main>
</div>
