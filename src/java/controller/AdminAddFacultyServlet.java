...
import model.AdminAddFacultyAuthenticator;
...
public class AdminAddFacultyServlet extends HttpServlet {
  public void doPost(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException
  {
     ...
     AdminAddFacultyAuthenticator student=new AdminAddFacultyAuthenticator();
     boolean insrt=student.isInsrt(user);
     if(insrt)
     {
        request.setAttribute("message", "Faculty Added Successfully");
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/adminAddFaculty.jsp");
