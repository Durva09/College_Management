...
public class AdminUpdateStudentServlet extends HttpServlet {
  public void doPost(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException
  {
     ...
     AdminUpdateStudentAuthenticator student=new AdminUpdateStudentAuthenticator();
     boolean updt=student.isUpdt(user);
     if(updt)
     {
        request.setAttribute("message", "Student Updated Successfully");
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/getAddStudentId.jsp");
