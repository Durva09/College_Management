...
import model.AdminUpdateFacultyAuthenticator;
import model.AdminUpdateStudentAuthenticator;
...
public class AdminUpdateFacultyServlet extends HttpServlet {
  public void doPost(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException
  {
     ...
     AdminUpdateFacultyAuthenticator faculty=new AdminUpdateFacultyAuthenticator();
     boolean updt=faculty.isUpdt(user);
     if(updt)
     {
        request.setAttribute("message", "Faculty Updated Successfully");
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/getAddFacultyId.jsp");
