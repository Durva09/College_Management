...
import model.AdminUpdateProfileAuthenticator;
...
public class AdminUpdateProfileServlet extends HttpServlet {
  public void doPost(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException
  {
     ...
     AdminUpdateProfileAuthenticator hod=new AdminUpdateProfileAuthenticator();
     ...
     {
         request.setAttribute("message", "Profile cannot be Updated");
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/adminHome.jsp");
        rd.include(request, response);
     }
  }
